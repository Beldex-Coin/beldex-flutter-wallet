                    ...
                    child: Container(
                      ...
                      child:Column(
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Padding(
                                ...
                                child: Text(S.of(context).unlockBeldexWallet,style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.07/3,fontWeight: FontWeight.w600,color:settingsStore.isDarkTheme ? Color(0xffEBEBEB): Color(0xff16161D)),),
                              ),
                            ],
                          ),
                          Container(
                           ...
                           // color: Colors.yellow,
                            child: Text(S.of(context).confirmYourScreenLockPinpatternAndPassword,style: TextStyle(fontSize:MediaQuery.of(context).size.height*0.05/3 ,color:settingsStore.isDarkTheme ? Color(0xff909090): Color(0xff303030)),)),
                        ...
                        Container(
                          ...
                          child:Text(S.of(context).touchTheFingerprintSensor,style: TextStyle(fontSize:13,color: Color(0xff909090)),)
                        ),
                        GestureDetector(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Padding(
                                  ...
                                  child: Text(S.of(context).usePattern,style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: Color(0xff0BA70F)),),
                                ),
                              ],
                            ),
                        ),
