                ...
                // }
                                            ...
                                            Clipboard.setData(ClipboardData(
                                                                    ...
                                                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                     ...
                                                                     right: MediaQuery.of(context).size.height*0.30/3
                                                                      ...
                                                                      content: Text(S
                                                                          .of(context)
                                                                          .copied,style: TextStyle(color: Color(0xffffffff),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  Container(
                                    child:Text('$formattedDate'  //'${transaction.date}'
                                    )
                                  ),
                                    ],
                                  ),
                                            ...
                                            Clipboard.setData(ClipboardData(
                                                                    ...
                                                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                     ...
                                                                     right: MediaQuery.of(context).size.height*0.30/3
                                                                      ...
                                                                      content: Text(S
                                                                          .of(context)
                                                                          .copied,style: TextStyle(color: Color(0xffffffff),fontWeight:FontWeight.w700,fontSize:15) ,textAlign: TextAlign.center,),
