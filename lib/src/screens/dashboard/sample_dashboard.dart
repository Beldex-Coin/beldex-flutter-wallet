              ...
              children: [
                ListView.builder(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Container( 
                                                                    height:20,width:20,
                                                                    child: SvgPicture.asset('assets/images/new-images/send.svg')),
                                                                  Padding(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                       children: [
                        SvgPicture.asset(settingsStore.isDarkTheme ? 'assets/images/new-images/notrans_black.svg': 'assets/images/new-images/notrans_white.svg'),
                        Padding(
