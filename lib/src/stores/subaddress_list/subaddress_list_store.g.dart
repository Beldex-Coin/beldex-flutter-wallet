...
part of 'subaddress_list_store.dart';
...
mixin _$SubaddressListStore on SubaddressListStoreBase, Store {
  final _$subaddressesAtom = Atom(name: 'SubaddressListStoreBase.subaddresses');
