...
class SwapTransactionUnPaidPage extends BasePage {
  SwapTransactionUnPaidPage({required this.transactionStatus});
  ...
  Widget body(BuildContext context) {
    return SwapTransactionUnPaidHome(transactionStatus: transactionStatus);
  }
}

class SwapTransactionUnPaidHome extends StatefulWidget {
  SwapTransactionUnPaidHome({required this.transactionStatus});

  final GetTransactionStatus transactionStatus;

  @override
  State<SwapTransactionUnPaidHome> createState() => _SwapTransactionUnPaidHomeState();
}

class _SwapTransactionUnPaidHomeState extends State<SwapTransactionUnPaidHome> {
  int currentStep = 4;
  int stepLength = 4;
  bool complete = false;
