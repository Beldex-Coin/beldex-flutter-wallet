...
class GetCurrenciesFullApiService {
  ...
  Future<GetCurrenciesFullModel?> getSignature() async {
    ...
    final signatureResponseBody =
        await callSignatureApiService(Apis.getCurrenciesFull, privacySwapApiEnable: privacySwapApiEnable);
    print('url --> 4');
    ...
    if (signature != null) {
      final getCurrenciesFullResponseBody =
          await callGetCurrenciesFullApiService(Apis.getCurrenciesFull,
              signatureResponseBody['signature'] as String, privacySwapApiEnable: privacySwapApiEnable);
