...
class DigestRequest {
  ...
  String generateHA2({String? method, required String uri}) {
  ...
  Map<String, String> parsetAuthorizationHeader({required String source}) {
  ...
  Future<__dio.Response> request(
      {required String uri, String? login, String? password, Map<String, dynamic>? requestBody}) async {
    const path = '/json_rpc';
    const method = 'POST';
