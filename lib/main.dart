...
import 'package:beldex_wallet/router.dart' as beldexroute;
import 'l10n.dart';
import 'theme_changer.dart';
import 'themes.dart';
import 'package:beldex_wallet/src/domain/common/get_encryption_key.dart';
...
import 'package:beldex_wallet/src/reactions/set_reactions.dart';
...
import 'package:beldex_wallet/src/screens/root/root.dart';
...
class BeldexWalletApp extends StatefulWidget {
  ...
  @override
  _BeldexWalletAppState createState() => _BeldexWalletAppState();
}
...
/*class BeldexWalletApp extends StatelessWidget {
  BeldexWalletApp() {
    SystemChrome.setPreferredOrientations(
        [DeviceOrientation.portraitUp, DeviceOrientation.portraitDown]);
  }
